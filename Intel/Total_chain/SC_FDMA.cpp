/*******************************************************************************
* Function:    SC_FDMA_mod
* Description: Single Carrier FDMA modulator
* Inputs:      N_ul_rb			 - Number of RBs assigned to the ue
*			   input_subframe    - Gride
*
* Outputs:     pusch_bb          - Modulated time domain signal
*
*
* by: Khaled Ahmed Ali 
********************************************************************************/
