...
/******************************* SCFDMA Modulator/Demodulator Parameters   *****************************************/
...
/**********************************************************************************************/
void sisoRx(_MKL_Complex8* pusch_bb, int N_ul_rb, float * bits, unsigned char subframe_number, unsigned int cell_ID, int ribits_length, char* out_ri_bits, char* out);
