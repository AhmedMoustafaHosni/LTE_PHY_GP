...
%              Ant_ports        - Number of Antenna ports used in MIMO
% Outputs:     symbs           - output symbols (each layer's data in a new matrix, i.e: input_subframe is 3D matrix)

%edit: 16/2/2017
%By  : Ahmed Moustafa
%Add MIMO by Ahmed Nour
%edit by Khaled Ahmed and Mohammed Osama

function symbs =  sc_fdma_demodulator_MIMO(pusch_bb, N_ul_rb, Ant_ports)
