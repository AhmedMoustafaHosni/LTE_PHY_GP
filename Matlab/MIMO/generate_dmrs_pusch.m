...
function [r] = generate_dmrs_pusch(N_subfr, N_id_cell, delta_ss, group_hopping_enabled, sequence_hopping_enabled, cyclic_shift, cyclic_shift_dci, w_config, N_prbs, layer)
...
% 
%     % Validate w_config
%     if(~( strcmp(w_config,'fixed') ||  strcmp(w_config,'table') ))
...
%     end
    ...
    c      = generate_psuedo_random_seq(c_init, 8*N_ul_symb*20);
    ...
    r_u_v_alpha_lambda(1,:) = generate_ul_rs(N_s, N_id_cell, 'pusch', delta_ss, group_hopping_enabled, sequence_hopping_enabled, alpha_lambda_1, N_prbs);
    r_u_v_alpha_lambda(2,:) = generate_ul_rs(N_s+1, N_id_cell, 'pusch', delta_ss, group_hopping_enabled, sequence_hopping_enabled, alpha_lambda_2, N_prbs);
