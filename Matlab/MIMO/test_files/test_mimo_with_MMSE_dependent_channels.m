...
% txSignalAfterChannel(1,:) = lteFadingChannel(chcfg,tx_signal(1,:).').';
% txSignalAfterChannel(2,:) = lteFadingChannel(chcfg,tx_signal(2,:).').';
...
equalised_subframe = equalise_channel_MMSE_mimo(Decoded_streams, channel,estimated_noise_power(i,:));
%% predecoding
