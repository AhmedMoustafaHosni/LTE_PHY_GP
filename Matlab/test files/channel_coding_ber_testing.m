...
% size of bits
M_bits = 576;  %% just to send one subframe see page 16 in 36211 release 8
...
%encoding
codded_data = convolutional_encoder(b);

% mapping
symbs = mapper(codded_data, 'qpsk');
...
for i = 1 : 1 : length(SNR)
    ...
    % decoding
    out_bits = viterbi_decoder(demapped_bits);
