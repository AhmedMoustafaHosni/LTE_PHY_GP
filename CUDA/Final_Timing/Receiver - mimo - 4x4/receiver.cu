...
int main(int argc, char **argv) {
	...
	generate_dmrs_pusch(n_s, N_id_cell, 0, 0, 0, 0, 0, "fixed", M_pusch_rb, 2, &dmrs1_generated_d, &dmrs2_generated_d, x_q_d);
	generate_dmrs_pusch(n_s, N_id_cell, 0, 0, 0, 0, 0, "fixed", M_pusch_rb, 3, &dmrs1_generated_d2, &dmrs2_generated_d2, x_q_d2);
