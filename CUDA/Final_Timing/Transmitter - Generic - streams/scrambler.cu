...
void scrambler(Byte* bits_d, Byte** scrambledbits_d, Byte* c_d, const int N, cudaStream_t stream)
{
	...
	scrabmler << <gridDim, blockDim, 0, stream >> > (bits_d, *scrambledbits_d, c_d, N);
