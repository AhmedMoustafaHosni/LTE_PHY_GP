...
void compose_subframe(cufftComplex* complex_data_d, cufftComplex* dmrs_1_d, cufftComplex* dmrs_2_d, const int M_pusch_rb, cufftComplex** subframe_d, int N_l)
{
	...
	compose_subframe << < grid, block >> >(complex_data_d, dmrs_1_d, dmrs_2_d, M_pusch_sc, *subframe_d, rsqrtf(N_l));
